...
export const SUPPORTED_LOCALES: ReadonlyArray<Locale> = ["en", "es", "zh-CN", "zh-TW", "pt-BR"];
...
class I18nManager {
  ...
  private loadLocale() {
    const saved = localStorage.getItem("jorchbot.i18n.locale");
  ...
  public async setLocale(locale: Locale) {
    ...
    this.locale = locale;
    localStorage.setItem("jorchbot.i18n.locale", locale);
    this.notify();
  }
