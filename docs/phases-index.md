...
| **8**  | [Seguridad](./phase-8-security-multi-llm.md)                       | TOTP 2FA, encryption at-rest, keychain, audit logging                         | Fase 6      |
| **9**  | [App Movil](./phase-9-mobile-app.md)                               | App propia iOS/Android                                                        | Fase 8      |
| **10** | [AgentRunner Abstraction](./phase-10-agent-runner.md)              | Interfaz AgentRunner + tool approval abstraction + CodexRunner + GeminiRunner | Fase 2, 8   |
| **HB** | [Heartbeat Integration](../specifications/phase-heartbeat/SPEC.md) | Heartbeat prompts a sesiones activas via ClaudeRunner                         | Fase 6      |
| **11** | [Headless LLM Orchestrator](./phase-11-headless-orchestrator.md)   | MCP server + memoria vectorial + cron + sub-agentes                           | Fase 10     |
| **12** | [Orchestrator UX & Advanced](./phase-12-orchestrator-ux.md)        | Transcripts tab, web chat, model routing, MCP marketplace, federation A2A     | Fase 11     |
...
(Jorchfile)(Tunnels) (UX Avanz) (Telegram)          │
           ...
           Fase 8 (Seguridad)                        │
             ...
             ▼                   ▼                   │
           Fase 9          Fase 10 ◄─────────────────┘
           (App Movil)     (AgentRunner Abstraction)
                             │
                             ▼
                           Fase 11
                           (Headless Orchestrator)
                             ...
                             ▼
                           Fase 12
                           (Orchestrator UX + Federation)

  Fase 6 (GUI)
    │
    ▼
  Fase HB (Heartbeat) ← tambien depende de Fase 2, Fase 3
```

**Fases 3, 4, 5 y 7 pueden desarrollarse en paralelo** despues de completar Fase 2.
**Fase 10 depende de Fase 2 (ClaudeRunner) + Fase 8 (encrypted API keys).**
...
## Documentos Conceptuales (Nice-to-have)

| Documento                                 | Descripcion                                                     | Dependencia |
| ----------------------------------------- | --------------------------------------------------------------- | ----------- |
| [Agent Office](./concept-agent-office.md) | Vision de agentes que se comunican, critican y mejoran entre si | Fase 11     |
